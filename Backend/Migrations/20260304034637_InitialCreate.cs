        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecialSkills = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "123 Le Loi, Q1, HCMC", true, 10.776899999999999, 106.7009, "Nguyen Van A", "0901234567", 4.7999999999999998, "A Motor Repair", "Engine, Tires" },
                    { 2, "456 Nguyen Hue, Q1, HCMC", true, 10.7745, 106.7032, "Tran Van B", "0987654321", 4.5, "B Quick Fix", "Battery, Start" },
                    { 3, "789 Tran Hung Dao, Q5, HCMC", true, 10.7554, 106.66679999999999, "Le Thi C", "0912223334", 4.9000000000000004, "C Motor Service", "All" }
                });
